...
ex5.onclick = function () {
    ...
    video.src = 'https://www.youtube.com/embed/22r8lIRjgJU'
...
ex1.onclick = function () {
    ...
    lista.style.top = '-580px'
    pdf.src = 'precisao7.pdf'
    video1.src = 'exPrecisao7.mp4'
    pdf.style.zIndex = '50'
...
ex3.onclick = function () {
    ...
    let dicaNavegacao = card('Dica', 'Use as teclas de 1 a 4 para navegar entre os modelos de arpejos')
    setTimeout(dicaNavegacao.mostrarCard(), 1000)
...
ex4.onclick = function () {
    ...
    soundslice.src = 'https://www.soundslice.com/slices/Dj9Vc/embed-channelpost/'
...
botao0.onclick = function () {
    ...
    if (posicao.value == 1) {
        ...
        apagar()
        criaShape(2, 4, 5, 2, 4, 5, 2, 4, 6, 2, 4, 6, 3, 5, 7, 4, 5, 7)
        ...
        apagar()
        criaShape(4, 5, 7, 4, 5, 7, 4, 6, 7, 4, 6, 7, 5, 7, 9, 5, 7, 9)
